...
$messages = $pdo->query("SELECT * FROM demonstrationXSS2_message WHERE id_receiver=".intval(getUserId()))->fetchAll();

$statement = $pdo->prepare("SELECT username FROM demonstrationXSS2_user WHERE id=:id");
